...
const FocusTimer = () => {
  ...
  const [tracks, setTracks] = useState([
    {
      id: "1",
      title: "Lofi - 1",
      prew: "./src/assets/lofi__prew-1.jpg",
      time: "2:30",
      music: "src/assets/Chill_Hip-Hop_Beats_-_Long_Travel_73622991.mp3",
    },
    {
      id: "2",
      title: "Lofi - 2",
      prew: "./src/assets/lofi__prew-2.jpg",
      time: "1:30",
      music:
        "src/assets/Detskie_pesni_Spokojjnaya_fonovaya_muzyka_LO-FI_BEATS_Chillhop_Music_Japanese_Lofi_Lo_Fi_Hip_Hop_-_Lou-ajj_Ritmy_dlya_Meditacii_79645134.mp3",
    },
    {
      id: "3",
      title: "Lofi - 3",
  ...
  return (
    <div className={styles["focus-timer"]}>
      <div className={styles.addedAndSkip}>
        <Button
          onClick={openClick}
          // className={`${button.button} ${button.track}`}
          type = 'track'
          title={"Выбрать трек"}
        />
        <Button
      ...
      {isOpen && (
        <div className={styles["div__overflow"]}>
          {tracks.map((track) => (
            <Track
              key={track.id}
              title={track.title}
